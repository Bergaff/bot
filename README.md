...
`npm test` — 448 тестов, `npm run typecheck` — `tsc --noEmit`.
...
| `tests/` | 448 тестов + фикстуры разметки, мини-DOM и мини-браузер | 1–7 |
