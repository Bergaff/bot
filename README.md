...
`npm test` — 398 тестов, `npm run typecheck` — `tsc --noEmit`.
...
открыть `web.telegram.org` → «Самопроверка». Подробно, с таблицей ошибок:
...
| `tests/` | 398 тестов + фикстуры разметки, мини-DOM и мини-браузер | 1–7 |
